---
name: verify-this
description: Verify a claim with fresh local evidence. Use when the user says verify this, prove it works, did this fix it, show me evidence, or a behavior/performance claim needs baseline and treatment comparison.
---
