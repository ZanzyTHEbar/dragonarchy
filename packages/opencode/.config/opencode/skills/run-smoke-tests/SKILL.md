...
description: Run Playwright smoke tests, debug failures, and verify fixes. Use when end-to-end smoke verification is needed before or after changes.
---
...
- Adapt command names to the current repository; do not assume these scripts exist.
