...
description: Summarize authored commits over a user-specified time period into a concise update. Use when the user asks what did I get done, what shipped, or asks for a status summary for yesterday, last week, or another range.
---
