typeset -gA ZSH_HIGHLIGHT_STYLES
        ...
        ZSH_HIGHLIGHT_STYLES[autodirectory]='fg=#ff9e64,italic,bold'
        ...
        ## Storage
        ## Strings
        ZSH_HIGHLIGHT_STYLES[command-substitution-quoted]='fg=#9ece6a'
        ZSH_HIGHLIGHT_STYLES[command-substitution-delimiter-quoted]='fg=#9ece6a'
        ...
        ZSH_HIGHLIGHT_STYLES[path]='fg=#c0caf5',bold
