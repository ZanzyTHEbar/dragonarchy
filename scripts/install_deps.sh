...
# Hyprland specific
hyprland_arch=("hyprland" "hyprshot" "hyprpicker" "hyprlock" "hypridle" "polkit-gnome" "libqalculate" "waybar" "mako" "swaybg" "swayosd" "xdg-desktop-portal-hyprland" "xdg-desktop-portal-gtk" "uwsm" "plymouth" "brightnessctl" "playerctl" "pamixer" "wireplumber" "pipewire" "fcitx5-im" "wl-clip-persist" "nautilus" "sushi" "ffmpegthumbnailer" "slurp" "satty" "mpv" "evince" "imv" "chromium" "gnome-themes-extra" "kvantum" "cargo" "clang" "llvm" "mise" "imagemagick" "mariadb-libs" "postgresql-libs" "lazygit" "docker" "docker-compose" "docker-buildx" "luarocks" "tree-sitter-cli" "gcc" "inetutils" "man-db" "tealdear" "less" "whois" "plocate" "bash-completion" "kitty" "iwd" "power-profiles-daemon" "tzupdate" "bluez" "bluez-utils" "blueberry" "cups" "cups-pdf" "cups-filters" "system-config-printer" "ufw" "ufw-docker" "nvidia-dkms" "nvidia-utils" "lib32-nvidia-utils" "egl-wayland" "libva-nvidia-driver" "qt5-wayland" "qt6-wayland")
hyprland_aur=("hyprland-qtutils" "wiremix" "impala" "walker-bin" "lazydocker-bin" "gnome-calculator" "gnome-keyring" "signal-desktop" "obsidian" "libreoffice-fresh" "obs-studio" "kdenlive" "xournalpp" "localsend-bin" "pinta" "typora" "spotify" "zoom" "wl-clipboard")
